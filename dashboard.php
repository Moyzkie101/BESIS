...
<?php 
	...
	$query8 = "SELECT * FROM financial";
	$financial = $conn->query($query8)->num_rows;

	$date = date('Y-m-d'); 
	$query9 = "SELECT SUM(amounts) as am FROM tblpayments WHERE `date`='$date'";
	$revenue = $conn->query($query9)->fetch_assoc();

	$query10 = "SELECT * FROM tblbrgy_info WHERE `id`= 1";
				...
				<div class="panel-header bg-primary-gradient">
							<div class="card">
										<div class="px-2 pb-2 pb-md-0 text-center">
											<h1 class="fw-bold mt-3"><?= ucwords($brgy) ?></h1>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title fw-bold">DATA SUMMARY OF THE BARANGAY</div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card card-stats card-round" style="background-color:#880a14; color:#fff">
								<div class="card-body">
									<div class="row">
										...
										<div class="col-6 col-stats">
											<div class="numbers mt-4">
												<h2 class="fw-bold text-uppercase">All Purok</h2>
