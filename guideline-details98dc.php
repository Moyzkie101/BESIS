...
<!-- Mirrored from www.brgyvictoriareyesinfosys.tech/backup/guideline-details?id=45 by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Nov 2022 14:47:05 GMT -->
...
<head>
	...
	<title>Barangay Bolocboloc</title>
                ...
                <div class="container clearfix">
                    ...
                    <div class="menu-links navbar-collapse collapse justify-content-start" id="menuDropdown">
						...
						<div class="nav-social-link">
							<a href="residents-2.php">Login</a>
						</div>
                    </div>
					<!-- Navigation Menu END ==== -->
                </div>
        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/cover1.jpg);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Barangay Bolocboloc Guidelines</h1>
				 </div>
            </div>
        </div>
						...
						<div class="row">
								...
								<div class="recent-news blog-lg">
									<div class="action-box blog-lg">
										<img src="assets/images/announcement/guidelines1.jpg" style="height: 320px;object-fit: cover;" alt="">
									</div>
									<div class="info-bx">
										<ul class="media-post">
											<li><i class="fa fa-calendar"></i> Dec. 18, 2021 5:23 AM</li>
										</ul>
										<h5 class="post-title">Guidelines</h5>
										<p><p>About guidelines</p><!-- <p data-f-id="pbf" style="text-align: center; font-size: 14px; margin-top: 30px; opacity: 0.65; font-family: sans-serif;">Powered by <a href="https://www.froala.com/wysiwyg-editor?pb=1" title="Froala Editor">Froala Editor</a></p>. --></p>
					...
					<div class="d-flex align-items-stretch">
						...
						<div class="pt-social-link">
							<ul class="list-inline m-a0">
								<li><a href="#" class="btn-link" target="blank"><i class="fa fa-facebook"></i></a></li>
								<!-- <li><a href="brgyvictoriareyes@gmail.com" class="btn-link"><i class="fa fa-google-plus"></i></a></li> -->
							</ul>
						</div>
							...
							<div class="col-3 col-lg-2 col-md-3 col-sm-3">
								<div class="widget footer_widget">
									...
									<ul>
										...
										<!-- <li><a href="https://dasmacitygov.weebly.com/city-government.html">Dasma City</a></li> -->
									</ul>
								</div>
							</div>
							<div class="col-3 col-lg-2 col-md-3 col-sm-3">
							...
							<div class="col-6 col-lg-8 col-md-6 col-sm-6">
								<div class="widget footer_widget">
									...
									<ul>
										...
										<!-- <li><a href="javascript:;"><span class="__cf_email__" data-cfemail="3e5c4c594748575d4a514c575f4c5b475b4d7e59535f5752105d5153">[email&#160;protected]</span></a></li> -->
									</ul>
								</div>
							</div>							
						</div>
