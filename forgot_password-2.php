                            ...
                            <div class="row placeani">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group form-forget">
                                        <span>Back to <a href="login_access-2.php">Login</a>.</span>
                                    </div>
                                </div>
...
<?php
   ...
   if (isset($_POST["submit"])) {
        ...
        $query2 = mysqli_query($conn,"select * from tbl_users where email='".$_POST["email"]."'");

        if (mysqli_affected_rows($conn) > 0) {

            $resident1 = mysqli_fetch_array($query1);
            $admin = mysqli_fetch_array($query2);

            if (mysqli_affected_rows($conn) > 0) {

                mysqli_query($conn,"UPDATE tbl_users SET code='".$code."' WHERE email='".$resident1['email']."'");
                mysqli_query($conn,"UPDATE tbl_users SET code='".$code."' WHERE email='".$admin['email']."'");
                ...
                try{
                    ...
                    $mail->Body    = 'Here is the Verification Link <b><a href="http://localhost/BIS/change_password.php?reset='.$code.'">http://localhost/BIS/change_password.php?reset='.$code.'</a></b>';
                    ...
                    ?>
                         <script> 
                            ...
                            window.location.href = "forgot_password-2.php";
                         </script>
                      <?php
                ...
                ?>
                    <script> 
                        ...
                        window.location.href = "login_access-2.php";
                    </script>
                <?php
                }
        } else {
            ?>
                <script> 
                    ...
                    window.location.href = "registration-2.php";
                </script>
            <?php
        }
   }
