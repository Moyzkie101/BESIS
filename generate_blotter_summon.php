...
<head>
	...
	<title>Blotter Report -  BIS</title>
</head>
<body>
								...
								<div class="card-body m-5" id="printThis">
                                  <div class="d-flex flex-wrap justify-content-around" style="border-bottom:1px solid red">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-center">
                                        <div class="col-md-9">
                                            <div class="text-center">
                                                <h2 class="mt-4 fw-bold">OFFICE OF THE PUNONG TAGAPAMAYAPA</h2>
                                            </div>
                                           <div class="text-center">
                                                <h1 class="mt-4 fw-bold mb-5"><u></u></h1>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                               ...
                                               <!--     <div class="form-group row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group row">
                                                        <h3 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Case No.:</h3>
                                                        <div class="col-lg-8 col-md-8 col-sm-8" style="border-bottom:1px solid black">
                                                            <span class="fw-bold" style="font-size:20px"><?= ucwords($resident['casenum']) ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <h3 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">For: </h3>
                                                        <div class="col-lg-8 col-md-8 col-sm-8" style="border-bottom:1px solid black">
                                                            <span class="fw-bold" style="font-size:20px">DIALOGUE</span>
                                                        </div>
                                                    </div>
                                             <!--       <div class="form-group row">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="text-center">
                                                <h1 class="mt-4 fw-bold mb-5"><u>SUMMON</u></h1>
                                            </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 text-justify">
                                                        <h3 class="mt-3" style="text-indent: 40px;">You are hereby summoned to appear before me in person, together with your witnesses, on <span class="fw-bold" style="font-size:20px"><?= date('F d, Y', strtotime($resident['date'])) ?></span> at <span class="fw-bold" style="font-size:20px"><?= date('h:i A', strtotime($resident['time'])) ?></span>, then and there to answer to a complaint made before me, for mediation of your disputes with complainant in the above entitled case.</h3>

	                                                     <h3 class="mt-3" style="text-indent: 40px;">You are hereby warned that if you refuse or willfully fail to appear in obedience to this summons, you may be barred from filing any counterclaim arising from said complaint.</h3>

	                                                     <h3 class="mt-3" style="text-indent: 40px;">FAIL NOT or else face punishment as for contempt of court.</h3>

                                                        <h3 class="mt-3" style="text-indent: 40px;">	This <span class="fw-bold" style="font-size:20px"><?= date('m/d/Y') ?></span></h3>
                                                    </div>
                                                </div>
                                            </div>
                                             </div>
