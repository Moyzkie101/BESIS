...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/vendors/calendar/fullcalendar.php">
	...
	<!-- <link rel="stylesheet" type="text/css" href="assets/css/dashboard.php"> -->
</head>
        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/cover1.jpg);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Barangay Bolocboloc Programs</h1>
				 </div>
            </div>
        </div>
