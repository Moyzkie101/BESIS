				...
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="assets/images/slider/slide11.jpg" alt="" 
							...
							<div class="mainText tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;">
									BRGY. <span style="color: #5691cf">BOLOCBOLOC</span>
							</div>
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="assets/images/slider/slide22.jpg" alt="" 
								data-bgposition="center center" 
								data-bgfit="cover" 
								data-bgrepeat="no-repeat" 
								data-bgparallax="10" 
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								style="z-index: 7; white-space: nowrap;text-transform:uppercase; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
									<span style="font-size: 23px;">Gara Bolocboloc!</span> 
							</div>
							...
							<div class="tp-caption Newspaper-Subtitle   tp-resizeme" 
								...
								data-paddingleft="[0,0,0,0]"
								style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;">
									ADUNAY MAS MAAYONG KALIDAD SA KINABUHI
							</div>
							<!-- LAYER NR. 4 -->
							<a href="registration.php"><div class="tp-caption Newspaper-Button rev-btn " 
								id="slide-200-layer-5" 
                ...
                <div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-12">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-services/pic11.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
										<i class="fa fa-book text-primary"></i>
									</div>
									<h4><a href="history.php">Our Story</a></h4>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx">
								<div class="action-box">
									<img src="assets/images/our-services/pic22.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
										<i class="fa fa-envelope-open text-primary"></i>
									</div>
									<h4><a href="all-announcements.php">Announcements</a></h4>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="service-bx m-b0">
								<div class="action-box">
									<img src="assets/images/our-services/pic33.jpg" alt="">
								</div>
								<div class="info-bx text-center">
									<div class="feature-box-sm radius bg-white">
