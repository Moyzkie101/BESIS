								...
								<div class="card-body m-5" id="printThis">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-12 mb-4">
                                            <h4 class="mb-0"><i>CTC No.</i>:<u> </u></h4>
                                            <h4 class="mb-0"><i>Issued On.   </i>: <u><span style="font-size:20px"><?= date('m/d/Y') ?></span></u></h4>
                                            <h4 class="mb-0"><i>Isuued at.   </i>: <u><?= ucwords($brgy.','.$town) ?></u></h4>
                                            <h4 class="mb-0"><i>OR No.</i>:<u><?= $row['or_info'] ?></u></h4>
                                        </div>
                            ...
                            <form method="POST" action="model/save_pment.php">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="Indicate O. R. No." name="or_info"></textarea>
                                </div>
                        </div>
