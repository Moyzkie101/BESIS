...
<head>
	...
	<title>Barangay Bolocboloc | SERVICES | BRGY. FACILITIES</title>
		...
		<div class="breadcrumb-row">
			<div class="container">
				<ul class="list-inline">
					...
					<li><a href="services.php">Services</a></li>
					<li>Use of Barangay Facilities</li>
					<?php
						error_reporting(0);
							...
							<div class="col-lg-8 col-xl-8">
								<div class="recent-news blog-lg">
									...
									<div class="info-bx">
										...
										<h5 class="post-title">Use of Barangay Facilities</h5>
										<p><p>1: Table</p><p> 2: Chairs</p><p> 3: Tents</p>
												<br></br>
										<h5>FEE</h5>
										<p>Table --------------------------------------------------------------------- P20.00</p>
										<p>Chairs --------------------------------------------------------------------- P5.00</p>
