...
<head>
	...
	<title>Brg Officials and Staff -  BESIS</title>
</head>
<body>
			...
			<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                            ...
                            <form method="POST" action="model/edit_official.php" >
								...
								<div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="contact" placeholder="Enter Contact No." name="contact" required>
                        ...
                        <div class="modal-footer">
                            <input type="TEXT" id="off_id" name="id" hidden>
