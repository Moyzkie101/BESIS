...
<head>
	...
	<title>Certificate of RESIDENCY -  BIS</title>
</head>
<body>
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Residency Issuance</div>
									</div>
								</div>
								<div class="card-body">
													...
													<tr>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" href="generate_resi_cert.php?id=<?= $row['id'] ?>" class="btn btn-link btn-primary" data-original-title="Generate Certificate">
