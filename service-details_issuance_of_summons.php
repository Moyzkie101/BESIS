...
<head>
	...
	<title>Barangay Bolocboloc | SERVICES | ISSUANCE OF SUMMONS</title>
							...
							<div class="col-lg-8 col-xl-8">
								<div class="recent-news blog-lg">
									...
									<div class="info-bx">
										...
										<h5 class="post-title">Issuance of Summons</h5>
										<p><p>STEP 1: Ask request slip and fill up your name.</p><p>STEP 2: Submit the filled up request slip.</p><p>STEP 3: Verify if listed in the registry of brgy. Inhabitant.</p>
											<br></br>
											<h5>FEE</h5>
											<p>P100.00</p>
											</p>
