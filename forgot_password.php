        ...
        if (mysqli_affected_rows($conn) > 0) {
            ...
            if (mysqli_affected_rows($conn) > 0) {
                ...
                try{
                    ...
                    $mail->Body    = 'Here is the Verification Link <b><a href="http://localhost/BIS/change_password.php?reset='.$code.'&email='.$_POST['email'].'">http://localhost/BIS/change_password.php?reset='.$code.'&email='.$_POST['email'].'</a></b>';
